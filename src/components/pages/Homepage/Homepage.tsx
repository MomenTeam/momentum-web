...
function Homepage(props: IHomepageProps) {
  ...
  const [needyInformations, setNeedyInformations] = React.useState<any>(undefined)

  const getNeedyInformations = async () => {
    await get('/needies/informations')
    setNeedyInformations(response.data.data)
  }

  useEffect(() => {}, [getNeedyInformations()])
  ...
  return (
    <>
      ...
      >
        {needyInformations &&
          needyInformations.map((needy: any, index: number) => {
            return (
